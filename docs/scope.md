...
### 10.3 Ngoài phạm vi dài hạn

| # | Hạng mục | Lý do chưa xem xét |
|---|---|---|
| B-14 | Offline mode / PWA sync | Phức tạp, nghiệp vụ yêu cầu live network | 
| B-15 | Native mobile app (iOS / Android) | Không cần — chỉ dùng Chrome (PC) và Safari (iPad) |
| B-16 | Tích hợp phần cứng | Máy in hóa đơn, barcode scanner, customer display |
| B-17 | BI / Analytics nâng cao | Ngoài phạm vi hệ thống POS — dùng Odoo reporting |
