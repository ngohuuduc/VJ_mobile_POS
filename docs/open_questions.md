...
| ID | Câu hỏi | Ảnh hưởng đến | Trạng thái | Câu trả lời |
|---|---|---|---|---|
| OQ-J01 | Có cho phép tạo đơn không có thông tin khách hàng (walk-in customer) không? | Luồng tạo đơn, data model | Đã xác nhận | Không — bắt buộc phải có khách hàng. |
