...
graph TD
    ...
    NGINX -->|static files| ImgStore["Local Storage\nẢnh sản phẩm"]
    FastAPI <-->|SQL| PG
...
| # | Hạng mục | Mô tả | Ưu tiên |
|---|---|---|---|
| B-14 | Email Service (mở rộng) | Gửi email xác nhận đơn hàng, biên lai thanh toán, thông báo đặt cọc cho KH. Provider: **AWS SES** (đã xác nhận). Giai đoạn đầu chỉ dùng cho reset password | Trung bình |
